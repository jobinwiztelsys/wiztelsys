...
public class CurrencyExchange extends Activity implements
		AdapterView.OnItemSelectedListener {

	String apiurl = "http://openexchangerates.org/api/latest.json?app_id=5252e0bd65684b04b9a3b53b9d48b839";

	public static String selctedincurrencytype, selctedoutcurrencytype,
			incurrencyAbbrevation, outcurrencyAbbrevation;
	...
	public static float fromcurrencyRate, toCurrencyRate, finalResult,
			currencyCount;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.currency_exchange_page);
		fromcurrencyRate = 0;
		toCurrencyRate = 0;
		finalResult = 0;
		currencyCount = 0;
		...
		ArrayAdapter<String> a1 = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, currencyTypes);
		...
		convertBtn = (Button) findViewById(R.id.currencyconvertBtn);
	...
	public void currencyConvert(View view) {
		...
		if (finalResult == 0) {
			...
			incurrency.setText(currencyCount + " " + incurrencyAbbrevation
					+ "=" + finalResult + "" + outcurrencyAbbrevation);
			finalResult = 0;
			currencyCount = 0;
	...
	public class getWebPageTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (finalResult > 0) {
					outcurency.setText(currencyCount + " "
							+ incurrencyAbbrevation + " = " + finalResult + " "
							+ outcurrencyAbbrevation);
					currencyCount = 0;
					incurrency.setText("");
	...
	public void onItemSelected(AdapterView<?> arg0, View view, int arg2,
		...
		case (R.id.toCurrencySpinner): {
			...
			outcurrencyAbbrevation = selctedoutcurrencytype.substring(start,selctedoutcurrencytype.length());
		}
